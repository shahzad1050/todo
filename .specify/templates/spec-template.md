...
- **Task**: Represents a todo item with ID, description, completion status, and timestamps
- **User**: Represents a user account with authentication credentials and associated tasks
- **Conversation**: Represents an AI chat session with message history (Phase III)
- **Message**: Represents individual messages in a conversation with content and metadata
